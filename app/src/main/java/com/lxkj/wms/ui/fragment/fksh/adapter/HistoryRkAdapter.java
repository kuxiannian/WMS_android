package com.lxkj.wms.ui.fragment.fksh.adapter;
...
import com.lxkj.wms.ui.fragment.fksh.HistoryRkDetailFra;
...
public class HistoryRkAdapter extends RecyclerView.Adapter<HistoryRkAdapter.ViewHolder> {
    ...
    public HistoryRkAdapter(Context mContext, List mDatas) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.ivDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ActivitySwitcher.startFragment(mContext, HistoryRkDetailFra.class, new Bundle());
            }
        });
    }
