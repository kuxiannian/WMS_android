package com.lxkj.wms.ui.fragment.putoff.adapter;
...
import com.lxkj.wms.ui.fragment.putoff.HistoryPutOffDetailFra;
 ...
 */
public class PutOffAdapter extends RecyclerView.Adapter<PutOffAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.item_putoff_history, parent, false));
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.ivDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivitySwitcher.startFragment(mContext, HistoryPutOffDetailFra.class, bundle);
            }
        });
